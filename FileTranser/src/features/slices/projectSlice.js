...
export const fetchProjects = createAsyncThunk('project/fetchProjects', async( _ , { getState , rejectWithValue} )=>{
    ...
    const payload = {
      ...
      scope_fields: ["_id", "title", "duration", "location", "logo","extend_date_list","extend_budget_list","budget_estimate_list","start_date","end_date" , 'status'],
    };
 
    try{
        const response = await axios.post( `${config.API_URL}getProjectList`, payload,  apiHeaderToken( token ) ); 
...
export const fetchProjectById = createAsyncThunk('project/details', async({ params, token }, {rejectWithValue} )=>{
    try{
        const response = await axios.post( `${config.API_URL}getProjectById`, params,  apiHeaderToken( token ) );
        return response.data;
    }catch( error ){
        return rejectWithValue(error.response.data);
    }
...
export const addProject = createAsyncThunk( 'project/Add', async( { formData, token } , {rejectWithValue})=>{
    try{ 
        const response = await axios.post( `${config.API_URL}addProject`, formData , apiHeaderTokenMultiPart( token ) ); 
        return response.data;
    }catch( error ){
        return rejectWithValue(error.response.data);
    }
...
export const updateProject = createAsyncThunk('project/Update', async( { formData, token } , {rejectWithValue})=>{
    try{
        const response = await axios.post( `${config.API_URL}editProject`, formData , apiHeaderTokenMultiPart( token ) );
        return response.data;
    }catch( error ){
        return rejectWithValue(error.response.data);
    }
...
export const deleteProject = createAsyncThunk( 'project/Delete', async( { payload, token }, {rejectWithValue})=>{
    try{
        const response = await axios.post( `${config.API_URL}deleteProject`, payload , apiHeaderToken( token ) );
        return response.data;
    }catch( error ){
        return rejectWithValue(error.response.data);
    }
...
export const fetchLocation = createAsyncThunk('project/Location', async( { params, token } , {rejectWithValue} )=>{
    try{ 
        const response = await axios.post( `${config.API_URL}getLocationList`, params, apiHeaderToken( token )  ); 
        return response.data;
    }catch( error ){
        return rejectWithValue(error.response.data);
    }
...
export const fetchHolidayList = createAsyncThunk('project/HolidayList', async( { params, token } , {rejectWithValue} )=>{ 
        try{  
        const response = await axios.post( `${config.API_URL}getHolidayListByDateRange`, params, apiHeaderToken( token )  ); 
        return response.data;
    }catch( error ){
        return rejectWithValue(error.response.data);
    }
...
export const extendProjectDuration = createAsyncThunk('project/extendDuration', async( { params, token } , {rejectWithValue} )=>{ 
    try{  
    const response = await axios.post( `${config.API_URL}extendProjectDuration`, params, apiHeaderToken( token )  ); 
    return response.data;
}catch( error ){
    return rejectWithValue(error.response.data);
}
...
export const saveProjectBudget = createAsyncThunk('project/saveBudget', async( { params, token } , {rejectWithValue} )=>{  
    try{
    const response = await axios.post( `${config.API_URL}extendProjectBudget`, params, apiHeaderToken( token )  ); 
    return response.data;
}catch( error ){
    return rejectWithValue(error.response.data);
}
...
const projectsSlice = createSlice({
    ...
    extraReducers : ( builder ) => {
        ...
        .addCase( fetchProjects.fulfilled, ( state, action ) => { 
                ...
                //     const combinedProjects = [...state.projects, ...action.payload.data]; 
...
export const { incrementPageNo } = projectsSlice.actions;
