            ...
            <div className="d-flex justify-content-between align-items-center bor-bot pb-3">
              ...
              <div className="card   width-select selectwraps">
                <div className="card-body p-0">
                  <div className="d-flex justify-content-between ">
                    <div
                      className={`position-relative width-third ${activeFields.ProfileExperience === 0 || formData.form_profile.some(index =>index?.label === 'Experience' && index.action === 'Mandatory') ? "active" : ""
                        }`}
                      onClick={() => {
                    ...
                    <div
                      className={`position-relative width-third ${activeFields.ProfileExperience === 1 || formData.form_profile.some(index =>index?.label === 'Experience' && index.action === 'Optional')  ? "active" : ""
                        }`}
                      onClick={() => {
                        resetActiveState("ProfileExperience");
                    ...
                    <div
                      className={`position-relative width-third ${activeFields.ProfileExperience === 2 || formData.form_profile.some(index =>index?.label === 'Experience' && index.action === 'off')  ? "active" : ""
                        }`}
                      onClick={() => {
                        resetActiveState("ProfileExperience");
