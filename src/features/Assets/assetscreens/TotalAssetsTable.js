...
export default function TotalAssetsTable({ paginationModel, setPaginationModel }) {
    const { totalCount, assetsRecord } = useSelector((state) => state.assets)
        ...
        <>
            <div className="w-100">
                <DataGrid
                    ...
                    rowCount={totalCount?.status === 'success' ? totalCount?.total?.data : 0}
