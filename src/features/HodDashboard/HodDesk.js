...
const HodDesk = () => {
    ...
    useEffect(() => {
        (async () => {
            try {
                // http://localhost:8080/v1/admin/dashboardHod?employee_id
                let response = await axios.get(`${config.API_URL}dashboardHod?employee_id=${loginUsers?.employee_doc_id}`, apiHeaderToken(config.API_TOKEN))
                ...
                <div className="container" data-aos="fade-in" data-aos-duration="3000">
                    ...
                    <div className=" ceocrdwrap atscard_wrap d-flex flex-row gap-3">
                        <div className="card rounded-3 card-border w-100 ceocards">
                            <Link to="/hod-mpr-list?type=listByHod">
                        ...
                        <div className="card rounded-3 card-border w-100 upcoming ceocards">
                            <Link to="/hod-mpr-list?type=ApprovedByHod">
                                <div className="card-body">
                                    <h6 className="smallsubhdng">
                                        Approved
                                    </h6>
                        ...
                        <div className="card rounded-3 card-border w-100 newer ceocards">
                            <Link to="/hod-mpr-list?type=PendingByHod">
                                <div className="card-body">
                                    <h6 className="smallsubhdng">
                                        Approval Pending
                                    </h6>
                    ...
                    <div className="ceocrdwrap atscard_wrap d-flex flex-row gap-3">
                        <div className="card rounded-3 card-border w-100 ceocards">
                            <Link to="/hod-approval-note?type=listByHod">
                                <div className="card-body">
                                    <h6 className="smallsubhdng">
                        ...
                        <div className="card rounded-3 card-border w-100 upcoming ceocards">
                            <Link to="/hod-approval-note?type=ApprovedByHod">
                                <div className="card-body">
                                    <h6 className="smallsubhdng">
                                        Approved Note
                                    </h6>
                        ...
                        <div className="card rounded-3 card-border w-100 newer ceocards">
                            <Link to="/hod-approval-note?type=PendingByHod">
                                <div className="card-body">
                                    <h6 className="smallsubhdng">
                                        Pending Notes
                                    </h6>
                    ...
                    <div className="ceocrdwrap atscard_wrap d-flex flex-row gap-3">
                        <div className="card rounded-3 card-border w-100 ceocards">
                            <Link to="/hod-interview-list?type=Completed">
                                <div className="card-body">
                                    <h6 className="smallsubhdng">
                                        Completed Interview
                                    </h6>
                        ...
                        <div className="card rounded-3 card-border w-100 upcoming ceocards">
                            <Link to="/hod-interview-list?type=Upcoming">
                                <div className="card-body">
                                    <h6 className="smallsubhdng">
                                        Upcoming Interview
                                    </h6>
                        ...
                        <div className="card rounded-3 card-border w-100 newer ceocards">
                            <Link to="/hod-interview-list?type=PendingFeedback ">
                                <div className="card-body">
                                    <h6 className="smallsubhdng">
                                        Pending feedbacks
                                    </h6>
                    ...
                    {/* appointment Letter approval */}

                    <div className="d-flex justify-content-between align-items-center mb-3 mt-4">
                        <div className="hrhdng">
                            <h2 className="">Appointment Letter</h2>
                            <p className="mb-0 text-start">
                                Appointment Letter Pending And Approve
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="ceocrdwrap atscard_wrap d-flex flex-row gap-3 mb-5">
                        <div className="card rounded-3 card-border w-100 ceocards">
                            <Link to="/appointment-approval-hod?type=all">
                                <div className="card-body">
                                    <h6 className="smallsubhdng">
                                        Total Appointment(s) Letter
                                    </h6>
                                    <div className="d-flex justify-content-between mt-3 align-items-center position-relative">
                                        <div className="d-flex flex-column align-items-start">
                                            <h2><CountUp end={totalRecords && totalRecords?.total_appointment_letter} duration={5} /></h2>
                                            <p className="crdtxt mb-0 d-flex flex-row gap-1">
                                                <span className="text-success">
                                                    <IoIosArrowRoundUp />
                                                    0
                        ...
                        <div className="card rounded-3 card-border w-100 upcoming ceocards">
                            <Link to="/appointment-approval-hod?type=Complete">
                                <div className="card-body">
                                    <h6 className="smallsubhdng">
                                    ...
                                    <div className="d-flex justify-content-between mt-3 align-items-center position-relative">
                                        <div className="d-flex flex-column align-items-start">
                                            <h2><CountUp end={totalRecords && totalRecords?.total_approved_appointment_letter} duration={5} /></h2>
                                            <p className="crdtxt  mb-0 d-flex flex-row gap-1">
                                                <span className="crdtxt text-success">
                                                    <IoIosArrowRoundUp />
                                                    0
                        ...
                        <div className="card rounded-3 card-border w-100 newer ceocards">
                            <Link to="/appointment-approval-hod?type=Pending">
                                <div className="card-body">
                                    <h6 className="smallsubhdng">
                                    ...
                                    <div className="d-flex justify-content-between mt-3 align-items-center position-relative">
                                        <div className="d-flex flex-column align-items-start">
                                            <h2><CountUp end={totalRecords && totalRecords?.total_pending_appointment_letter} duration={5} /></h2>
                                            <p className="crdtxt mb-0 d-flex flex-row gap-1">
                                                <span className="text-success">
                                                    <IoIosArrowRoundUp />
                                                    0
