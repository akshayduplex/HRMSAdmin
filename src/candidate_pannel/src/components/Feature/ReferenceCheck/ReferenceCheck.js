...
import ReferenceDataDataGrid from "./ReferenceTables";
...
const ReferenceCheck = () => {
    ...
    const FetchApprovalListRecords = useCallback(async () => {
        ...
        try {
            ...
            let response = await axios.post(`${config.API_URL}employee-reference-check`, payloads, apiHeaderToken(config.API_TOKEN))
                ...
                <div className="mb-4">
                    <div className="d-flex align-items-center mb-3">
                        <TextField
                            fullWidth
                            variant="outlined"
                            placeholder="Search by Employee Name , Email , Mobile , Project, Department..."
                            value={searchTerm}
...

                    {
                        tabValue === "Pending" && (
                            <TabPanel value={tabValue} index={tabValue}>
                                <ReferenceDataDataGrid ReferenceData={approvalRecords} status={tabValue} loading={isFetching} />
                            </TabPanel>
                        )
                    }
