...
import SearchInput from '../../../../../features/CeoDashboard/SearchBox';
...
export default function AppointmentApproval() {
    ...
    const getPendingCandidatesList = async () => {
        try {
            setLoading(true);
            let payload = { "page_no": "1", "per_page_record": "1000", "keyword": "" , "employee_id":user?._id  }
    ...
    return (
        <div className="maincontent">
            <div className="container">
                ...
                <Box sx={{ height: 440, width: '100%', bgcolor: 'background.paper', borderRadius: 2, position: 'relative' }}>
                    {loading ? (
                        <SkeletonTable />
                    ) : (
                        <DataGrid
